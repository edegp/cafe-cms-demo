...
class RemindMessage(DynamoDB):
    ...
    def put_push_message(self, user_id, channel_id, flex_message, remind_date):
        """
        プッシュメッセージを登録する
    ...
    def _get_timestamp_after_one_week(self, date):
        ...
        """
        # データ削除期限日を指定
        after_one_week_date_utc = datetime.strptime(date, "%Y-%m-%d") + ONE_WEEK
